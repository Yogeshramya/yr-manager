...
export default function ExpenseReportLoading() {
  return (
    <div className="space-y-8 pb-12 animate-pulse">
      ...
      <div className="glass-card rounded-2xl p-6 border border-slate-800 h-96 flex flex-col items-center justify-center gap-3">
        <Loader2 className="animate-spin text-red-400" size={32} />
        <p className="text-xs text-slate-400 font-semibold">Loading Expense Analytics & Expenditures...</p>
      </div>
    </div>
  );
}
